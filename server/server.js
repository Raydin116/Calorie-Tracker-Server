...
// Add the frontend URL to the whitelist
const domainWhiteList = process.env.DOMAIN_WHITELIST 
  ? JSON.parse(process.env.DOMAIN_WHITELIST) 
  : ['http://localhost:3000', 'http://localhost:5173', 'https://calorie-tracker-psi-flame.vercel.app'];
